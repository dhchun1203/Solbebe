    ...
    >
      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] flex flex-col animate-fade-in-up border border-transparent dark:border-gray-800">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-800">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-100">이용약관</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 custom-scrollbar">
          <div className="prose prose-sm md:prose-base max-w-none text-gray-700 dark:text-gray-200 space-y-6">
            <section>
              <h3 className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-3">제1조 (목적)</h3>
            ...
            <section>
              <h3 className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-3">제2조 (정의)</h3>
            ...
            <section>
              <h3 className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-3">제3조 (약관의 게시와 개정)</h3>
            ...
            <section>
              <h3 className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-3">제4조 (서비스의 제공 및 변경)</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              <h3 className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-3">제5조 (주문 및 결제)</h3>
              <p className="leading-relaxed mb-2">
            ...
            <section>
              <h3 className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-3">제6조 (배송)</h3>
              <p className="leading-relaxed mb-2">
            ...
            <section>
              <h3 className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-3">제7조 (취소 및 환불)</h3>
              <p className="leading-relaxed mb-2">
            ...
            <section>
              <h3 className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-3">제8조 (면책사항)</h3>
              <p className="leading-relaxed">
            ...
            <section>
              <h3 className="text-lg md:text-xl font-bold text-gray-800 dark:text-gray-100 mb-3">제9조 (준거법 및 관할법원)</h3>
              <p className="leading-relaxed">
