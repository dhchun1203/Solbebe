    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-1">최근 7일 문의</p>
              <p className="text-2xl font-bold text-gray-800">{stats.recentInquiries}</p>
            </div>
            <div className="w-12 h-12 bg-pastel-beige rounded-full flex items-center justify-center">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <button
            ...
            className="flex items-center gap-4 p-4 rounded-lg border-2 border-gray-200 hover:border-pastel-pink hover:bg-pastel-pink/5 transition-all cursor-pointer text-left w-full"
          >
          ...
          <button
            ...
            className="flex items-center gap-4 p-4 rounded-lg border-2 border-gray-200 hover:border-pastel-blue hover:bg-pastel-blue/5 transition-all cursor-pointer text-left w-full"
          >
            ...
            <div className="flex-1">
              <p className="font-semibold text-gray-800">문의 관리</p>
              <p className="text-sm text-gray-600">고객 문의 확인 및 관리</p>
            </div>
            <svg className="w-5 h-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
